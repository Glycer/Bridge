...
public static class Inputs
{
    ...
    public static KeyCode defense = KeyCode.V;

    public static KeyCode ability1 = KeyCode.R;
    public static KeyCode ability2 = KeyCode.T;
    public static KeyCode ability3 = KeyCode.F;
    public static KeyCode ability4 = KeyCode.G;
